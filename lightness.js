...
(function(root){
  ...
  var pixelate = function(image,gridx,gridy,box){
    ...
    var result = [];
    var dx = Math.floor(canvas.width/gridx); //we're going to miss a pixel here and there if width is not divisable by gridsize, but that's ok
    var dy = Math.floor(canvas.height/gridy);
    var y = 0;
    var x = 0;
